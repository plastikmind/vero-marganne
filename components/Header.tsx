    ...
    <div className='flex flex-col items-center justify-center '>
       ...
       <div>
          <ul className='flex items-center justify-center mt-5 lg:mt-10 text-[#be1e2d] text-lg sm:text-2xl lg:text-4xl font-extralight'>
            ...
            <div>
            <li className='peer mr-2 sm:mr-4 lg:mr-8 xl:mr-12 hover:text-[#cd9c5a]'>Collections</li>
            {/* menu */}
            <div className="hidden peer-hover:flex hover:flex
         w-48 md:w-[240px]
         flex-col bg-white drop-shadow-lg">
            <Link className="px-5 py-3 hover:bg-gray-200 hover:text-[#cd9c5a]" href="/african">African Poem</Link>
            <Link className="px-5 py-3 hover:bg-gray-200 hover:text-[#cd9c5a]" href="/aya">Aya</Link>
        </div>
            </div>
            <li className='mr-2 sm:mr-4 lg:mr-8 xl:mr-12 hover:text-[#cd9c5a]'><Link href="/about">About</Link></li>
          </ul>
       </div>
    </div>
  )
