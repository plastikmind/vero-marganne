    ...
    <div className='flex flex-col w-full'>
      ...
      <div className='flex flex-col sm:flex-row items-center justify-center w-full'>
         ...
         <div className='hidden sm:flex w-full flex-col ml-2 mt-10 sm:mt-0 lg:ml-[4%] xl:ml-[10%] min-[1920px]:ml-[14%]'>
          <div className={roboto.className}>
            ...
            <div className='mt-5'>
              ...
              <Link href='https://shop.veromarganne.com/page/2/'>
        ...
        <div className='flex flex-col w-full justify-end items-center sm:items-end mt-16 mr-2 lg:mr-[6%] xl:mr-[10%] min-[1920px]:mr-[15%]'>
          <Link href='https://shop.veromarganne.com/product/the-traveller-tree-orange/' className='w-[360px] h-[452px] md:w-[480px] md:h-[602.5px] 2xl:w-[637px] 2xl:h-[800px] relative'>
       ...
       <div className='flex w-full mt-16 sm:mt-20 lg:mt-32 xl:mt-40'>
          <div className='flex w-full items-center justify-center flex-col'>
            ...
            <Link href='https://shop.veromarganne.com/product/the-three-beauties-beige/' className='h-80 w-80 lg:h-[480px] lg:w-[480px] xl:h-[555px] xl:w-[555px]  relative'>
